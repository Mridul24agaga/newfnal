        ...
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <div className="space-y-2">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight mb-10">
              Submit your <span className="text-[#EB5C0E]">product now</span>. Get listed on
              <span className="text-[#EB5C0E]"> 200+ directories</span> today.
            </h2>
          </div>
          ...
          <div className="flex flex-col items-center space-y-4">
            <Link
              href="/#pricing"
              className="inline-flex items-center bg-[#EB5C0E] text-white rounded-lg px-8 py-3 font-semibold hover:bg-orange-600 transition-all text-lg"
            >
              Get Started
            </Link>
          </div>
