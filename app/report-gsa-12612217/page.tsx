          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <div className="col-span-full bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="font-bold text-lg mb-2">GSA Scheduled Services</h3>
                </div>
                <a href="https://www.gsascheduleservices.com/" target="_blank" rel="noopener noreferrer" className="text-black">
