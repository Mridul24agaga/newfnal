          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <div className="col-span-full bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="font-bold text-lg mb-2">Pricesnap</h3>
                </div>
                <a 
                  href="https://pricesnap.io/ "
                  target="_blank"
            ...
            <div className="col-span-full bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm">Improve your heading structure: Heading level skipped. "Instant Insights at Your Finger Tips" should be H2 instead of H3. Heading level skipped. "No typing necessary" should be H4 instead of H6. Heading level skipped. "Get Insights" should be H4 instead of H6. Heading level skipped. "Starter" should be H4 instead of H6. Heading level skipped. "Free" should be H4 instead of H6. Heading level skipped. "Excited to uncover the true value of your items?" should be H3 instead of H6</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm">The current page is blocked by robots.txt. If this is unintentional, update your robots.txt file.</p>
                </div>

                <div>
                  <h4 className="font-bold">Content Structure & Accessibility</h4>
                  <p className="text-sm text-gray-600">Score: 99/100</p>
            ...
            <div className="col-span-full mt-6 bg-gray-50/80 border border-gray-200 rounded-lg p-6">
              ...
              <ul className="list-disc list-inside space-y-2">
                <li><strong>Heading Structure:</strong> Correct the heading hierarchy to ensure proper content structure. Use H2 for main sections, followed by H3 and H4 for subsections.</li>
                <li><strong>Structured Data:</strong> Implement structured data to enhance how your content appears in search results and potentially improve click-through rates.</li>
                <li><strong>Robots.txt Configuration:</strong> Review and update your robots.txt file to ensure it's not unintentionally blocking important pages from being indexed.</li>
                <li><strong>Content Length:</strong> Aim to expand your content to reach a minimum of 300 words per page, providing more context for search engines and users.</li>
                <li><strong>Page Titles:</strong> Optimize your page titles to be between 50-60 characters for better visibility in search results.</li>
                <li><strong>Image Optimization:</strong> Add descriptive alt tags to all images to improve both accessibility and SEO.</li>
              </ul>
