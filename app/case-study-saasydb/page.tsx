        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="mb-8">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-gray-900">
                SaasyDB – Elevating Domain Rating from 8 to 35 in 60 Days
              </h1>

              <div className="flex flex-wrap gap-4 mb-6">
                <div className="flex items-center">
                  <span className="font-medium text-gray-700 mr-2">Client:</span>
                  <span className="text-gray-600">saasyDB</span>
                </div>
                <div className="flex items-center">
                  <span className="font-medium text-gray-700 mr-2">Founder:</span>
                  <span className="text-gray-600">Stuart</span>
                </div>
                <div className="flex items-center">
                  <span className="font-medium text-gray-700 mr-2">Industry:</span>
                  <span className="text-gray-600">B2B SaaS Lead Database</span>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div className="relative h-64 md:h-80 lg:h-96 w-full rounded-xl overflow-hidden shadow-md">
              <Image src="/getmorebacklinksgrowth.jpeg" alt="saasyDB Dashboard" fill className="object-cover" />
            </div>
          </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-baseline">
                      <p className="text-2xl font-bold text-orange-600">3.5x</p>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-12">
            ...
            >
              ...
              <div className="prose prose-lg text-gray-700">
                <p>
                  saasyDB, a platform offering a comprehensive database of SaaS company contacts, aimed to improve its
                  online authority to attract more users and enhance visibility. Despite offering valuable services, the
                  website's Domain Rating (DR) was relatively low at 8, limiting its search engine visibility and
                  credibility.
                </p>
              </div>
            </section>
            ...
            >
              ...
              <div className="prose prose-lg text-gray-700">
                <p>
                  To address this, saasyDB partnered with GetMoreBacklinks.org to implement a strategic
                ...
                <ul className="space-y-4 mt-4">
                  <li className="flex items-start">
                    ...
                    <span>
                      ...
                      reputable directories relevant to the SaaS industry, such as Product Hunt, G2, and Capterra.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <div className="bg-orange-100 rounded-full p-1 mr-3 mt-1">
            ...
            >
              <div className="relative h-64 w-full rounded-xl overflow-hidden shadow-md">
                <Image
                  src="/saasydb.png"
                  alt="saasyDB Domain Rating Growth"
                  fill
                  className="object-cover"
                />
              </div>
              <p className="text-center text-sm text-gray-500 mt-2">saasyDB's Domain Rating growth over 60 days</p>
            </div>
            ...
            >
              ...
              <div className="prose prose-lg text-gray-700">
                <p>Within 60 days, saasyDB experienced a remarkable improvement in its SEO metrics:</p>
                <ul className="space-y-4 mt-4">
                  <li className="flex items-start">
                    <div className="bg-orange-100 rounded-full p-1 mr-3 mt-1">
                      <svg className="w-4 h-4 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span>
                      <strong>Domain Rating:</strong> Increased from 8 to 35.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <div className="bg-orange-100 rounded-full p-1 mr-3 mt-1">
                    ...
                    <span>
                      <strong>Referring Domains:</strong> Grew from 15 to over 120 unique domains.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <div className="bg-orange-100 rounded-full p-1 mr-3 mt-1">
                    ...
                    <span>
                      <strong>Organic Traffic:</strong> Saw a 3.5x increase in monthly visitors.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <div className="bg-orange-100 rounded-full p-1 mr-3 mt-1">
            ...
            >
              ...
              <div className="prose prose-lg text-gray-700">
                <p>
                  saasyDB's collaboration with GetMoreBacklinks.org showcases the effectiveness of strategic
                  backlink-building in enhancing online authority and visibility. By focusing on high-quality directory
                  submissions and consistent information, saasyDB significantly improved its Domain Rating and overall
                  SEO performance within a short period.
                </p>
                <p className="mt-4">
