          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            <div className="bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="font-bold text-lg mb-2">HathrAI</h3>
                </div>
                <a href="https://hathr.ai/" target="_blank" rel="noopener noreferrer" className="text-black">
            ...
            <div className="col-span-full bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    Improve your heading structure: Document doesn't start with an H1. Heading level skipped. "Click
                    here to check out Hathr AI's prompt guide  should be H1 instead of H5
                  </p>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
              <div className="relative h-[400px]">
                <Image src="/hathr1.png" alt="Startupanz.com confirmation" fill className="object-contain" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
              <div className="relative h-[400px]">
                <Image src="/hathr2.png" alt="ProductHunt submission" fill className="object-contain" />
              </div>
            </div>
          </div>
        </section>
