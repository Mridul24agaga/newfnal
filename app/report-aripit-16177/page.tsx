    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <main className="container mx-auto py-12 px-4">
        ...
        <section className="bg-gray-50/80 border border-gray-200 rounded-lg p-6 mb-12">
          ...
          <p className="mb-6">Your startup has been submitted to 150+ websites. This extensive list covers a wide range of platforms, increasing your chances of visibility and success.</p>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <div className="col-span-full bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="font-bold text-lg mb-2">PlayPickups</h3>
                </div>
                <a 
                  href="https://playpickups.app/"
                  target="_blank"
            ...
            <div className="col-span-full bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Score: 20/100</p>
                  <p className="text-sm">Title is too short. Aim for 50-60 characters.</p>
                </div>

                <div>
                  <h4 className="font-bold">Meta & SEO Tags</h4>
                  <p className="text-sm text-gray-600">Score: 58/100</p>
                ...
                <div>
                  ...
                  <p className="text-sm">Improve your heading structure: Multiple H1 headings found</p>
                </div>
            ...
            <div className="col-span-full mt-6 bg-gray-50/80 border border-gray-200 rounded-lg p-6">
              ...
              <ul className="list-disc list-inside space-y-2">
                <li><strong>Sitemap:</strong> Ensure your sitemap is accessible and properly configured for search engines to crawl your site effectively.</li>
                <li><strong>Robots.txt:</strong> Create or fix your robots.txt file to guide search engine crawlers and improve indexing.</li>
                <li><strong>Canonical URLs:</strong> Implement canonical URLs to specify the preferred version of each page and avoid duplicate content issues.</li>
                <li><strong>Multilingual SEO:</strong> If applicable, add hreflang tags to indicate language variations of your content.</li>
                <li><strong>Structured Data:</strong> Implement structured data markup to enhance how your content appears in search results.</li>
                <li><strong>Image Optimization:</strong> Add descriptive alt tags to all images to improve accessibility and SEO.</li>
                <li><strong>Title Tags:</strong> Optimize your title tags to be between 50-60 characters for better visibility in search results.</li>
                <li><strong>Meta Descriptions:</strong> Improve your meta descriptions to be between 120-160 characters to provide more informative snippets in search results.</li>
                <li><strong>Heading Structure:</strong> Ensure each page has only one H1 heading and maintain a logical heading hierarchy.</li>
                <li><strong>Link Maintenance:</strong> Regularly check and fix any broken links to improve user experience and SEO performance.</li>
              </ul>
