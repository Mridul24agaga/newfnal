            ...
            <ul className="space-y-6">
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p>Expect results to appear within 60-90 days after submission. Be patient and use this time to refine your product.</p>
                </div>
              </li>
              <li className="flex items-start">
                <div className="mr-4 mt-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <div className="col-span-full bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="font-bold text-lg mb-2">FinanzApp</h3>
                </div>
                <a 
                  href="https://finanzapp.io/"
                  target="_blank"
