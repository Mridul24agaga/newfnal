          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="col-span-full bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Score: 0/100</p>
                  <p className="text-sm">Improve your heading structure: Heading level skipped. "Benefits" should be H2 instead of H6. Heading level skipped. "Features" should be H3 instead of H6. Heading level skipped. "Features" should be H4 instead of H6. Heading level skipped. "1. Submit an FAQ Document" should be H3 instead of H4. Heading level skipped. "Testimonials" should be H3 instead of H6. Heading level skipped. "FAQ" should be H4 instead of H6</p>
                </div>

                <div>
                  <h4 className="font-bold">Content Structure & Accessibility</h4>
                  <p className="text-sm text-gray-600">Score: 64/100</p>
            ...
            <div className="col-span-full mt-6 bg-gray-50/80 border border-gray-200 rounded-lg p-6">
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li><strong>Heading Structure:</strong> Ensure proper heading hierarchy (H1, H2, H3, etc.) throughout your content for better organization and SEO.</li>
