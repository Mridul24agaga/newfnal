          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            <div className="bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="font-bold text-lg mb-2">DeenDirectory</h3>
                </div>
                <a href="https://www.deendirectory.com/" target="_blank" rel="noopener noreferrer" className="text-black">
            ...
            <div className="col-span-full bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm">
                    Add more internal links to improve site structure and help search engines understand your content
                    hierarchy.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Score: 0/100</p>
                  <p className="text-sm">
                    Consider adding more content to reach a minimum of 300 words for better SEO.
                  </p>
                </div>
                ...
                <div>
                  <h4 className="font-bold">Links & Navigation</h4>
                  <p className="text-sm text-gray-600">Score: 96/100</p>
                  <p className="text-sm">
