          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <div className="col-span-full bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="font-bold text-lg mb-2">Procion AI</h3>
                </div>
                <a 
                  href="https://proicon.ai/"
                  target="_blank"
            ...
            <div className="col-span-full bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Score: 0/100</p>
                  <p className="text-sm">Add an og:title tag to optimize how your content appears when shared on social media.</p>
                </div>
                ...
                <div>
                  <h4 className="font-bold">Meta & SEO Tags</h4>
                  <p className="text-sm text-gray-600">Score: 45/100</p>
            ...
            <div className="col-span-full mt-6 bg-gray-50/80 border border-gray-200 rounded-lg p-6">
              ...
              <ul className="list-disc list-inside space-y-2">
                <li><strong>Sitemap and Robots.txt:</strong> Ensure your domain is accessible and has a valid robots.txt file.</li>
                <li><strong>Canonical URLs:</strong> Add canonical URLs to specify the preferred version of each page.</li>
                <li><strong>Multilingual SEO:</strong> If applicable, add hreflang tags to indicate language variations of your content.</li>
                <li><strong>Meta Tags:</strong> Optimize your meta description and title length, and add og:title tags for social media sharing.</li>
